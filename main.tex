...
I have a mixed background of \textbf{industry} and \textbf{academia}. I am comfortable working on large code bases and designing complex systems. I extensively worked with \textbf{C++}, \textbf{Rust}, \textbf{C}, \textbf{Python}, \textbf{C\#}, and \textbf{Coq} in production enviroments. I am \textbf{outgoing} and I \textbf{love working in teams}.
...
\begin{twenty} % Environment for a list with descriptions
	\twentyitem{Since 2022}{Software engineer -- Robotics and AI.}{Wayve Ltd}{ 
		...
		The software collects frames from different sensor; aligns, packages, and uploads enormous amounts of data, and runs a neural network for real-time inference. \textit{(C++, Rust, Python)}. }
